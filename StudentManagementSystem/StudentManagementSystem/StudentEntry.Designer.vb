...
Partial Class StudentEntry
    ...
    Private Sub InitializeComponent()
        ...
        dtbirth.Location = New Point(167, 403)
        ...
        Label5.Location = New Point(42, 411)
        Label5.Name = "Label5"
        ...
        cbgender.Location = New Point(167, 463)
        ...
        Label6.Location = New Point(42, 475)
        Label6.Name = "Label6"
        ...
        Label7.Font = New Font("Unispace", 10.2F, FontStyle.Bold, GraphicsUnit.Point)
        Label7.Location = New Point(42, 530)
        Label7.Name = "Label7"
        ...
        cbreligion.FlatStyle = FlatStyle.Flat
        cbreligion.Font = New Font("Unispace", 12F, FontStyle.Bold, GraphicsUnit.Point)
        cbreligion.FormattingEnabled = True
        cbreligion.Items.AddRange(New Object() {"Roman Catholic", "Christian", "Muslim", "Iglesia Ni Cristo", "Seventh-day Adventist", "Jehovah's Witnesses"})
        cbreligion.Location = New Point(167, 524)
        cbreligion.Name = "cbreligion"
        cbreligion.Size = New Size(250, 32)
        cbreligion.TabIndex = 12
        ' 
        ' Label8
        ' 
        ...
        txtaddress.Size = New Size(334, 120)
        ...
        GroupBox2.Controls.Add(cbreligion)
